	...
	companion object
	{
		...
		fun loadAbstractActionSequenceAction(classID: String): com.lyeeedar.ActionSequence.Actions.AbstractActionSequenceAction
		{
			return when (classID)
			{
				...
				"ProcessTargetsIndividually" -> com.lyeeedar.ActionSequence.Actions.ProcessTargetsIndividuallyAction()
				...
				"AddTargetsToSource" -> com.lyeeedar.ActionSequence.Actions.AddTargetsToSourceAction()
				"RestoreTargets" -> com.lyeeedar.ActionSequence.Actions.RestoreTargetsAction()
				"ScreenJolt" -> com.lyeeedar.ActionSequence.Actions.ScreenJoltAction()
